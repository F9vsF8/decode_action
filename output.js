//Thu May 15 2025 03:50:49 GMT+0000 (Coordinated Universal Time)
...
class _0x37005b {
  ...
  async ["task"](_0x4609c6, _0x411b86, _0x472f55, _0x2b192e) {
    ...
    _0x4609c6.indexOf("T") >= 0 ? _0x16cdb6.form = JSON.parse(_0x2b192e) : _0x16cdb6.body = _0x2b192e;
    _0x472f55.Host = _0x411b86.replace("//", "/").split("/")[1];
    return new Promise(async _0x105f6b => {
...
function _0x3b3f39() {
  return new class {
    ...
    ["ExamineCookie"]() {
      ...
      console.log("共找到" + _0x32afb4 + "个账号");
      return $.cookie_list;
    }
    ["task"](_0x3b7a5c, _0x576ebe, _0x54a35a, _0x4d7bf8, _0x4fc56f) {
      _0x3b7a5c == "delete" ? _0x3b7a5c = _0x3b7a5c.toUpperCase() : _0x3b7a5c = _0x3b7a5c;
      _0x3b7a5c == "post" && (delete _0x54a35a["content-type"], delete _0x54a35a["Content-type"], delete _0x54a35a["content-Type"], $.safeGet(_0x4d7bf8) ? _0x54a35a["Content-Type"] = "application/json;charset=UTF-8" : _0x54a35a["Content-Type"] = "application/x-www-form-urlencoded", _0x4d7bf8 && (_0x54a35a["Content-Length"] = $.lengthInUtf8Bytes(_0x4d7bf8)));
      _0x3b7a5c == "get" && (delete _0x54a35a["content-type"], delete _0x54a35a["Content-type"], delete _0x54a35a["content-Type"], delete _0x54a35a["Content-Length"]);
      _0x54a35a.Host = _0x576ebe.replace("//", "/").split("/")[1];
      return new Promise(async _0x327180 => {
        {
    ...
    ["decodeUnicode"](_0x5daa42) {
      _0x5daa42 = _0x5daa42.replace(/\\u/g, "%u");
      return unescape(unescape(_0x5daa42));
    }
    ...
    ["timecs"]() {
      ...
      JSON.stringify(_0x47e997).indexOf(" ") >= 0 && (_0x47e997 = _0x47e997.replace(" ", "T"));
      return new Date(_0x47e997).getTime() - 28800000;
    }
    ...
    ["RSA"](_0x29c393, _0x2b8642) {
      ...
      _0x1f3e03.setOptions({
        "encryptionScheme": "pkcs1"
      });
      return _0x1f3e03.encrypt(_0x29c393, "base64", "utf8");
    }
...
async function _0x52d72b(_0x3e1caa, _0x35542b) {
  ...
  _0x5a989e.setOptions({
    "encryptionScheme": "pkcs1"
  });
  return _0x5a989e.encrypt(_0x3e1caa, "base64", "utf8");
}
