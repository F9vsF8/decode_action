//Thu Jun 05 2025 09:37:26 GMT+0000 (Coordinated Universal Time)
//Base:<url id="cv1cref6o68qmpt26ol0" type="url" status="parsed" title="GitHub - echo094/decode-js: JS混淆代码的AST分析工具 AST analysis tool for obfuscated JS code" wc="2165">https://github.com/echo094/decode-js</url>
//Modify:<url id="cv1cref6o68qmpt26olg" type="url" status="parsed" title="GitHub - smallfawn/decode_action: 世界上本来不存在加密，加密的人多了，也便成就了解密" wc="741">https://github.com/smallfawn/decode_action</url>
const _0x5f00b5 = _0x5b30bc("太平通");
const _0x5bbd51 = require("got");
const _0x58ebaa = require("crypto");
const _0x2f8eee = "tpt";
const _0x260134 = /[\n\&\@]/;
const _0x36b5da = [_0x2f8eee + "Cookie"];
const _0x6e5c25 = 20000;
const _0x39aaf8 = 3;
const _0x1bbe9e = 1.01;
const _0x30d839 = "tpt";
const _0x5dbce6 = "https://leafxcy.coding.net/api/user/leafxcy/project/validcode/shared-depot/validCode/git/blob/master/code.json";
const _0x87e027 = "https://leafxcy.coding.net/api/user/leafxcy/project/validcode/shared-depot/validCode/git/blob/master/" + _0x30d839 + ".json";
const _0x28b094 = "Mozilla/5.0 (iPhone; CPU iPhone OS 16_1_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;yuangongejia#ios#kehutong#CZBIOS";
let _0x560acf = "";
const _0x43586e = "andh2008";
const _0x437263 = ["c21efc7a3a1143dbb4f7153f4f86f9ec", "5e568fc735ee43d88b8ef21ede710d95", "cec802f688c141a89f54b7ab293a5bf9", "16380925306613080", "26a01a8935be444782bddecb81544d82", "16380925697608952", "16382541378969738", "16382541050472997", "16382541529132238"];
const _0x1777b6 = 2000;
const _0x3c4b28 = 5;
const _0x44a3a3 = {
  height: 667,
  width: 375
...
function _0x50719f() {
  if (!_0x560acf) {
    let _0x8aa8ec = 0;
    let _0x2d1177 = _0x28b094.match(/.{1,4}/g);
...
class _0x31446a {
  ...
  get_prefix(_0x48fe9d = {}) {
    var _0x41bdbb = "";
    var _0x407a75 = _0x5f00b5.userCount.toString().length;
    if (this.index) {
  ...
  async request(_0x14be82) {
    ...
    const _0x41898b = ["TimeoutError"];
    let _0x58317b = _0x5f00b5.copy(_0x14be82);
    let _0x2f7325 = {};
    try {
      let _0x405ce4 = null;
      let _0x33f990 = 0;
      let _0x334465 = _0x58317b.fn || _0x58317b.url;
      let _0x51dd69 = _0x58317b.valid_code || [200];
      let _0x10e6be = _0x58317b.retry_code || [];
      if (_0x58317b.form) {
      ...
      while (_0x33f990 < _0x39aaf8) {
        ...
        try {
          ...
          let _0x3e4d15 = false;
          let _0x5b62bb = Date.now();
          let _0x342217 = _0x4cf7b9(_0x58317b);
          let _0x21759c = setTimeout(() => {
            _0x3e4d15 = true;
            _0x342217.cancel();
          }, _0x5111ba);
          ...
          let _0xac4137 = _0x28fec5 - _0x5b62bb;
          let _0x1ce2bc = _0x405ce4?.["statusCode"] || null;
      ...
      let _0x3aa1d1 = _0x5f00b5.get(_0x58317b, "decode_json", true);
...
class _0x15ca64 extends _0x31446a {
  ...
  async registerAndLogin(_0x52bb10 = _0x43586e, _0x1487b6 = {}) {
    ...
    try {
      ...
      let _0x2c20cb = _0x5f00b5.get(_0x73d9c7, "errorCode", _0x6a973c);
      if (_0x2c20cb === 0) {
        let {
          accessKey: _0x586a6c,
          phone: _0x2b1444
  ...
  async couponAndsign(_0x4bb256 = {}) {
    ...
    try {
      ...
      let _0x431bb8 = _0x5f00b5.get(_0x3c246c, "code", _0x44012b);
      if (_0x431bb8 == "0000") {
        _0x1d9fe4 = true;
        let {
          signFlag: _0x4a1b34,
  ...
  async get_task_list(_0x49ffa5 = {}) {
    try {
      ...
      let _0x9a174d = _0x5f00b5.get(_0x2cf19e, "code", _0x576e14);
      if (_0x9a174d == "0000") {
        let _0x19d67a = false;
        let _0x1bdcd5 = _0x2cf19e?.["data"]?.["taskList"] || [];
  ...
  async task_finish(_0x45e5b5, _0x2fbd41 = {}) {
    try {
      ...
      let _0x541162 = _0x5f00b5.get(_0x3b2243, "code", _0x3dd2e4);
      if (_0x541162 == "0000") {
  ...
  async goldCoin_add(_0x3fa219, _0x36177d = {}) {
    try {
      ...
      let _0x12ff89 = _0x5f00b5.get(_0x440715, "code", _0x1491f6);
      if (_0x12ff89 == "0000") {
  ...
  async get_articles(_0x23d679 = 1, _0x50162b = {}) {
    ...
    try {
      ...
      let _0x105e1 = _0x5f00b5.get(_0x131082, "code", _0x2e591a);
      if (_0x105e1 == "0000") {
  ...
  async coinInfoV2(_0x330ef4, _0x58ca49 = {}) {
    try {
      ...
      let _0x37ec12 = new URL("https://ecustomercdn.itaiping.com/static/newscontent/#/info");
      ...
      let _0x598a2a = _0x5f00b5.get(_0x2c5713, "code", _0x59e3ff);
      if (_0x598a2a == "0000") {
  ...
  async read_gold(_0x29a9ef, _0xd896c2, _0x92d3d8 = {}) {
    try {
      ...
      let _0x1dd30e = _0x5f00b5.get(_0x5d3219, "code", _0x398d20);
      if (_0x1dd30e == "0000") {
  ...
  async queryList(_0x2a7fd2 = {}) {
    try {
      ...
      let _0x2724b2 = _0x5f00b5.get(_0x4c70ca, "code", _0x46c58c);
      if (_0x2724b2 == "0000") {
  ...
  async getAllCoins(_0x43262c = {}) {
    try {
      ...
      let _0x29804d = _0x5f00b5.get(_0x365acb, "code", _0x22f529);
      if (_0x29804d == "0000") {
  ...
  async exhibitionTopic(_0x4247cb = 1, _0x3290ef = 10, _0x2c4a1f = {}) {
    ...
    try {
      ...
      let _0x25fa9f = _0x5f00b5.get(_0x292f72, "code", _0x605076);
      if (_0x25fa9f == "0000") {
  ...
  async standInLineTopic(_0x212283, _0x1fba48 = {}) {
    try {
      ...
      let _0x2044b4 = _0x5f00b5.get(_0xb44c7f, "code", _0x23584d);
      if (_0x2044b4 == "0000") {
  ...
  async giftBag(_0x5862a3 = {}) {
    try {
      ...
      let _0xaaf850 = _0x5f00b5.get(_0x1b05f0, "code", _0x89d858);
      if (_0xaaf850 == "0000") {
  ...
  async lottery(_0x2bcb4e, _0x3f156e = {}) {
    try {
      ...
      let _0x1f167c = _0x5f00b5.get(_0x4f4ed4, "errorCode", _0x193cce);
      if (_0x1f167c == 0) {
  ...
  async queryUserPoints(_0xd3f311 = {}) {
    try {
      ...
      let _0x123cff = _0x5f00b5.get(_0x5229a8, "code", _0x390573);
      if (_0x123cff == "0000") {
        let {
  ...
  async topic_task(_0x541f08 = {}) {
    try {
      ...
      let _0x26e82f = _0x1ac47c.filter(_0x322fd6 => !_0x322fd6.isParticipateIn && _0x322fd6.dispenseCoin < _0x322fd6.totalCoin);
...
function _0x5b30bc(_0x1ee12d) {
  return new class {
    ...
    padStr(_0x4620be, _0x2ff322, _0x4353ef = {}) {
      ...
      let _0x49ffb2 = _0x4353ef.mode || "l";
      let _0x43490b = String(_0x4620be);
      let _0x58b436 = _0x2ff322 > _0x43490b.length ? _0x2ff322 - _0x43490b.length : 0;
      let _0x223a0a = "";
    ...
    str2json(_0x18daf7, _0x4bc31a = false) {
      ...
      for (let _0x2b1034 of _0x18daf7.split("&")) {
        ...
        let _0x583fe0 = _0x2b1034.substr(_0x4051d3 + 1);
        if (_0x4bc31a) {
    ...
    async exitNow() {
      ...
      let _0x448ca7 = (_0x5dac47 - this.startTime) / 1000;
      this.log("");
      const _0x31cdb3 = {
        time: true
      };
    ...
    async wait_until(_0x3cbbca, _0x43fa9d = {}) {
      ...
      let _0x4770fe = _0x43fa9d.interval || this.default_wait_interval;
      let _0xd159be = _0x43fa9d.limit || this.default_wait_limit;
      let _0x35017f = _0x43fa9d.ahead || this.default_wait_ahead;
      ...
      let _0x279c45 = this.time("hh:mm:ss.S", _0x5a90fa);
      let _0x1b629b = Date.now();
